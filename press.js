...
module.exports = {
  tr: {
    ...
    videoNote: "26 saniye, seslendirme yok, İngilizce alt yazı. Ekranlar gerçek uygulamadan, iki yıllık kayıt geçmişiyle çekildi.",
  ...
  en: {
    ...
    videoNote: "26 seconds, no voice-over, English captions. Recorded from the real app with two years of worship records.",
