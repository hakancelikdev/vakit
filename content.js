...
const COPY = {
  tr: {
    ...
    "t-4b": "Kimliğinizi içermeyen kullanım verisi — neyin gönderildiği gizlilik politikasında tek tek yazılı. Bir dakikada okunacak kadar kısa, öyle de kalacak.",
  ...
  en: {
    ...
    "t-4b": "Usage data that carries no identity — the privacy policy lists exactly what is sent. It is short enough to read in a minute, and it will stay that way.",
