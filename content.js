 ...
 */
const LANGS = {
  tr: { name: "Türkçe", htmlLang: "tr", ogLocale: "tr_TR", path: "/", dir: ".", script: "latin", shots: "tr", video: "tr", city: "istanbul" },
  en: { name: "English", htmlLang: "en", ogLocale: "en_US", path: "/en/", dir: "en", script: "latin", shots: "en", video: "en", city: "london" },
  ar: { name: "العربية", htmlLang: "ar", ogLocale: "ar_SA", path: "/ar/", dir: "ar", script: "arabic", rtl: true, shots: "ar", video: "en", city: "mecca" },
  az: { name: "Azərbaycan dili", htmlLang: "az", ogLocale: "az_AZ", path: "/az/", dir: "az", script: "latin", shots: "en", video: "en", city: "baku" },
  bn: { name: "বাংলা", htmlLang: "bn", ogLocale: "bn_BD", path: "/bn/", dir: "bn", script: "bengali", shots: "bn", video: "en", city: "dhaka" },
  da: { name: "Dansk", htmlLang: "da", ogLocale: "da_DK", path: "/da/", dir: "da", script: "latin", shots: "da", video: "en", city: "copenhagen" },
  de: { name: "Deutsch", htmlLang: "de", ogLocale: "de_DE", path: "/de/", dir: "de", script: "latin", shots: "de", video: "en", city: "berlin" },
  es: { name: "Español", htmlLang: "es", ogLocale: "es_ES", path: "/es/", dir: "es", script: "latin", shots: "es", video: "en", city: "madrid" },
  fa: { name: "فارسی", htmlLang: "fa", ogLocale: "fa_IR", path: "/fa/", dir: "fa", script: "arabic", rtl: true, shots: "en", video: "en", city: "tehran" },
  ff: { name: "Pulaar", htmlLang: "ff", ogLocale: "ff_SN", path: "/ff/", dir: "ff", script: "latin", shots: "en", video: "en", city: "dakar" },
  fr: { name: "Français", htmlLang: "fr", ogLocale: "fr_FR", path: "/fr/", dir: "fr", script: "latin", shots: "fr", video: "en", city: "paris" },
  hi: { name: "हिन्दी", htmlLang: "hi", ogLocale: "hi_IN", path: "/hi/", dir: "hi", script: "devanagari", shots: "hi", video: "en", city: "delhi" },
  id: { name: "Bahasa Indonesia", htmlLang: "id", ogLocale: "id_ID", path: "/id/", dir: "id", script: "latin", shots: "id", video: "en", city: "jakarta" },
  it: { name: "Italiano", htmlLang: "it", ogLocale: "it_IT", path: "/it/", dir: "it", script: "latin", shots: "it", video: "en", city: "rome" },
  ja: { name: "日本語", htmlLang: "ja", ogLocale: "ja_JP", path: "/ja/", dir: "ja", script: "japanese", shots: "ja", video: "en", city: "tokyo" },
  ms: { name: "Bahasa Melayu", htmlLang: "ms", ogLocale: "ms_MY", path: "/ms/", dir: "ms", script: "latin", shots: "ms", video: "en", city: "kualalumpur" },
  nl: { name: "Nederlands", htmlLang: "nl", ogLocale: "nl_NL", path: "/nl/", dir: "nl", script: "latin", shots: "nl", video: "en", city: "amsterdam" },
  pt: { name: "Português", htmlLang: "pt", ogLocale: "pt_PT", path: "/pt/", dir: "pt", script: "latin", shots: "pt", video: "en", city: "lisbon" },
  ru: { name: "Русский", htmlLang: "ru", ogLocale: "ru_RU", path: "/ru/", dir: "ru", script: "cyrillic", shots: "ru", video: "en", city: "moscow" },
  sq: { name: "Shqip", htmlLang: "sq", ogLocale: "sq_AL", path: "/sq/", dir: "sq", script: "latin", shots: "en", video: "en", city: "tirana" },
  sw: { name: "Kiswahili", htmlLang: "sw", ogLocale: "sw_KE", path: "/sw/", dir: "sw", script: "latin", shots: "en", video: "en", city: "nairobi" },
  th: { name: "ไทย", htmlLang: "th", ogLocale: "th_TH", path: "/th/", dir: "th", script: "thai", shots: "th", video: "en", city: "bangkok" },
  ug: { name: "ئۇيغۇرچە", htmlLang: "ug", ogLocale: "ug_CN", path: "/ug/", dir: "ug", script: "arabic", rtl: true, shots: "en", video: "en", city: "urumqi" },
  ur: { name: "اردو", htmlLang: "ur", ogLocale: "ur_PK", path: "/ur/", dir: "ur", script: "urdu", rtl: true, shots: "ur", video: "en", city: "karachi" },
  zh: { name: "简体中文", htmlLang: "zh-Hans", ogLocale: "zh_CN", path: "/zh/", dir: "zh", script: "chinese", shots: "zh", video: "en", city: "beijing" },
};
...
const COPY = {
  tr: {
    ...
    eyebrow: "İbadetin yarıda kesilmesin",
    pillars: "Ücretsiz · Reklamsız · İnternetsiz · Hesap gerektirmez",
    ...
    p1: "App Store · {ratingCount} değerlendirme", p3: "Hesaplama yöntemi", p4: "Arayüz dili",
    nextPrayer: "Sıradaki · içinde",
    "sc-head": "Her şey, fazlası değil",
    "sc-h2a": "Bir arkadaş,", "sc-h2b": "bir dikkat makinesi değil.",
    "sc-lede": "{screenCount} temel araç, her biri açılır açılmaz huzur hissettirecek şekilde tasarlandı.",
    "trust-eye": "Emanet",
    "trust-h1": "Verilerin", "trust-h2": "bir emanettir,", "trust-h3": "bir ürün değil.",
    "trust-lede": "Diğer ibadet uygulamaları konum verilerini satarken yakalandı. Vakit farklı bir yol seçti: koordinatların sunucumuza hiç gelmez. Hesap yok. Reklam yok. Verilerin satılmaz.",
    "t-1a": "İndir. Aç. Kıl.",
  ...
  en: {
    ...
    eyebrow: "Don't let your worship be interrupted",
    pillars: "Free · Ad-free · Offline · No account",
    ...
    p1: "App Store · {ratingCount} ratings", p3: "Calculation methods", p4: "Interface languages",
    nextPrayer: "Next · in",
    "sc-head": "Everything, nothing extra",
    "sc-h2a": "A companion,", "sc-h2b": "not an attention machine.",
    "sc-lede": "{screenCount} core tools, each designed to feel calm the moment you open it.",
    "trust-eye": "Emanet — a trust",
    "trust-h1": "Your data is", "trust-h2": "a trust,", "trust-h3": "not a product.",
    "trust-lede": "Other prayer apps have been caught selling location data. Vakit went a different way: your coordinates never reach our servers. No account. No ads. Your data is never sold. This isn't a feature — it's a principle.",
...
const FEATURES = {
  tr: [
    ...
    { n: "Çalma Listeleri", d: "Sûreleri istediğin sıraya diz, listene ad ver, baştan sona dinle; indirip internetsiz de çal." },
    ...
    { n: "Cuma Rehberi", d: "Hazırlık, gusül, hutbe, Kehf sûresi ve salât ü selâm — cuma günü tek sayfada." },
  ...
  en: [
    ...
    { n: "Playlists", d: "Line up surahs in your own order, name the list and play it end to end — offline too." },
    ...
    { n: "Friday Guide", d: "Preparation, ghusl, the khutbah, Surah al-Kahf and salawat — the whole Friday on one page." },
    ...
    { n: "Prayer Discipline", d: "How long after each prayer enters you pray — the last 30 days and all time." },
