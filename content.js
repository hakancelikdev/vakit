...
const META = {
  tr: {
    ...
    description:
      "Namaz vakitlerini takip edin, Kıble yönünü bulun, Kur'an-ı Kerim okuyun. iPhone, Apple Watch ve Mac; 13 hesaplama yöntemi, Live Activities, kilit ekranı widget'ları, Cuma hutbesi, kaza takibi. Tamamen ücretsiz, reklamsız, çevrimdışı.",
    keywords:
      "namaz vakitleri, vakit, kıble yönü, namaz vakti, kuran, kur'an-ı kerim, hatim, tefsir, zikir, zikirmatik, ibadet takibi, kaza namazı takibi, cuma hutbesi, kerahat vakitleri, sahur alarmı, apple watch, mac uygulaması, islamic app, prayer times, qibla direction, quran, hicri takvim, live activities, widget, dynamic island, namaz uygulaması",
  },
  en: {
    title: "Vakit: Prayer Times, Qibla, Quran",
    description:
      "Track prayer times, find the Qibla, read the Quran. iPhone, Apple Watch and Mac; 13 calculation methods, Live Activities, lock screen widgets, Friday sermon, qada tracking. Completely free, ad-free, offline.",
    keywords:
      "prayer times, qibla direction, quran app, islamic app, muslim prayer app, adhan, salah tracker, qada tracker, dhikr counter, hijri calendar, apple watch prayer times, mac prayer times, live activities, prayer widget, free prayer app, ad-free islamic app",
  },
};
...
const COPY = {
  tr: {
    ...
    "fin-p": "Şu an ücretsiz. Hesap yok. Çevrimdışı çalışır. iPhone, Apple Watch ve Mac — iOS 26 ve üzeri.",
  ...
  en: {
    ...
    "fin-p": "Free today. No account. Works offline. iPhone, Apple Watch and Mac — iOS 26 and up.",
...
const FEATURES = {
  tr: [
    ...
    { n: "Kaza Takibi", d: "Ömür kazanı vakit bazlı takip et, borcunu erit." },
  ...
  en: [
    ...
    { n: "Qada Tracking", d: "Track missed prayers by time slot and clear the debt." },
...
const COMPARE = {
  tr: [
    ...
    { f: "Cihazlar", o: "Yalnız telefon; saat ve masaüstü yok ya da yarım.", v: "iPhone, Apple Watch ve Mac — iCloud ile senkron." },
  ...
  en: [
    ...
    { f: "Devices", o: "Phone only; watch and desktop missing or half-built.", v: "iPhone, Apple Watch and Mac — synced over iCloud." },
