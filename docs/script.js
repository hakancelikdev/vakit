...
const COPY = {
  en: {
    ...
    p1: "App Store \u00B7 41 reviews", p2: "Free \u00B7 today", p3: "Calculation methods", p4: "Offline \u00B7 on-device",
    nextPrayer: "Next \u00B7 in",
  ...
  tr: {
    ...
    p1: "App Store \u00B7 41 yorum", p2: "\u00DCcretsiz \u00B7 \u015Fu an", p3: "Hesaplama y\u00F6ntemi", p4: "\u00C7evrimd\u0131\u015F\u0131 \u00B7 cihazda",
...
const REVIEWS = {
  en: [
    ...
    {t:"Vakit.", b:"What a great app \u2014 works offline and free. I\u2019d recommend it to everyone.", n:"Tu\u011Fra Homan"},
    {t:"\u2764\uFE0F", b:"A very nice and useful app. The khatm feature is wonderful.", n:"Kullnc\u013169"},
    {t:"Well done.", b:"An amazing app.", n:"OzanGalenar"},
    {t:"Vakit", b:"What a great app, thanks Hakan \u00C7elik.", n:"A\u2026 H\u2026."},
  ],
  tr: [
    ...
    {t:"Vakit.", b:"Harika bir uygulama olmu\u015F hem internetsiz ve \u00FCcretsiz herkese \u00F6neririm.", n:"Tu\u011Fra Homan"},
    {t:"\u2764\uFE0F", b:"\u00C7ok g\u00FCzel kullan\u0131\u015Fl\u0131 bir uygulama. Hatim \u00F6zelli\u011Fi \u00E7ok g\u00FCzel.", n:"Kullnc\u013169"},
    {t:"Eme\u011Finize Sa\u011Fl\u0131k", b:"Harika bir uygulama.", n:"OzanGalenar"},
    {t:"Vakit", b:"Harika bir uygulama olmu\u015F te\u015Fekk\u00FCrler Hakan \u00C7elik.", n:"A\u2026 H\u2026."},
  ]
};
